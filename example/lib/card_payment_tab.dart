...
class CardPaymentTab extends StatefulWidget {
  final LiqPay liqPay;

  const CardPaymentTab({super.key, required this.liqPay});

  @override
  State<CardPaymentTab> createState() => _CardPaymentTabState();
}

class _CardPaymentTabState extends State<CardPaymentTab> {
          ...
          Padding(
            ...
            child: ElevatedButton(
              onPressed: () async {
                ...
                await widget.liqPay.purchase(order);
              },
